...
export function Logomark({ size = 30 }: LogomarkProps) {
  return (
    ...
    >
      ...
      <rect x="8" y="18" width="3.4" height="6" rx="1.4" fill="#fcd34d" opacity="0.92" />
      <rect x="14.3" y="14" width="3.4" height="10" rx="1.4" fill="#fcd34d" opacity="0.92" />
      <rect x="20.6" y="9" width="3.4" height="15" rx="1.4" fill="#fff" />
      <circle cx="22.3" cy="9" r="2.4" fill="#fcd34d" />
      <circle
        cx="22.3"
        cy="9"
        r="4.4"
